    ...
    get_stock_availability(item, settings) {
      if (settings.show_stock_availability && !item.has_variants) {
        if (item.on_backorder) {
          return `
					<br>
					<span class="out-of-stock mt-2" style="color: #fc7b3f;">
        ...
        return `
				<div id="${item.name}" class="btn
					...
					style="margin-top: 0px !important; max-height: 30px; float: right;
						padding: 0.25rem 1rem; min-width: 135px; background-color: #fc7b3f;">
					<span class="mr-2">
				...
				<a href="/cart">
					<div id="${item.name}" class="btn
						...
						${item.in_cart ? "" : "hidden"}"
						data-item-code="${item.item_code}"
						style="padding: 0.25rem 1rem; min-width: 135px; background-color: #fc7b3f;">
...
//# sourceMappingURL=erpnext-web.bundle.5LQH5I42.js.map
